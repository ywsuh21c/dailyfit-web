...
import { DefenseLayers } from '@/components/tech/DefenseLayers';
...
export default async function EnTechnologyPage() {
  ...
  return (
    <>
      ...
      <SpreadSection n="01" label="How it works">
      ...
      <SpreadSection n="02" label="System architecture" tone="paper">
        <Reveal>
      ...
      <SpreadSection n="03" label="Data · Privacy">
        <Reveal>
      ...
      <SpreadSection n="04" label="Security architecture" tone="paper">
        <div className="grid gap-12 lg:grid-cols-[minmax(0,1fr)_minmax(0,420px)] lg:items-center lg:gap-14">
          ...
          <Reveal delay={120}>
            <DefenseLayers
              layers={['Network · access control', 'Application boundary', 'Data encryption']}
              coreTitle="Personal-data core"
              aria="Layered defense: a personal-data core sitting inside network, application, and encryption boundaries"
            />
          </Reveal>
        </div>
      </SpreadSection>

      <SpreadSection n="05" label="Defensibility">
        <Reveal>
      ...
      <SpreadSection n="06" label="Radically Transparent" tone="paper">
        <Reveal>
